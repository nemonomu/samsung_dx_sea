...
from .step00_config import DEFAULT_LOWES_RUN_ROOT, lowes_product_type, lowes_run_date, rel_path
...
def s3_uri():
    parts = [part for part in [S3_PREFIX, "lowes", PRODUCT_TYPE, RUN_DATE] if part]
