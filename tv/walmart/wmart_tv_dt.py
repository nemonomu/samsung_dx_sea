...
class WalmartTVDetailCrawler(WalmartBaseCrawler):
    ...
    def run(self):
        ...
        try:
            ...
            self.detail_report['bsr_records'] = sum(
                1 for product in product_list
                if str(product.get('page_type') or '').lower() == 'bsr'
            )
    ...
    def extract_sku(self, product, product_url, modal_tree, mst_sku):
    ...
    def extract_screen_size(self, product, modal_tree, mst_screen_size):
