...
from tv.walmart.wmart_tv_main import WalmartTVMainCrawler
from tv.walmart.wmart_tv_bsr import WalmartTVBSRCrawler
from tv.walmart.wmart_tv_dt import WalmartTVDetailCrawler
...
def build_walmart_tv_email_report(crawl_results, detail_report, log_file, elapsed, failed_stages, error_message=None):
    ...
    has_warning = bool(redirects or run_errors)
