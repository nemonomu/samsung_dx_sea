...
CREATE INDEX. This terminates ONLY sessions that are `idle in transaction` and
have been so longer than DB_UNLOCK_IDLE_SECONDS (default 60), excluding this
connection. It never touches `active` (running) queries or fresh sessions.
Set DB_UNLOCK_DRY_RUN=1 to only report.
"""
import os
