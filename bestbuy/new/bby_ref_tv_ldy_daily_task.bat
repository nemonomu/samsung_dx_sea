...
set "CHAIN_NAME=REF_TV_LDY"
set "CHAIN_ORDER=REF TV LDY"
...
set "CHAIN_LOG=%CHAIN_LOG_DIR%\daily_task_ref_tv_ldy_%CHAIN_TS%.log"

echo ==================================================
echo BestBuy REF+TV+LDY daily task started
echo order=%CHAIN_ORDER%
echo cwd=%CD%
echo chain_log=%CHAIN_LOG%
echo ==================================================
echo ================================================== > "%CHAIN_LOG%"
echo BestBuy REF+TV+LDY daily task started >> "%CHAIN_LOG%"
...
echo ==================================================
echo BestBuy REF+TV+LDY daily task completed
echo elapsed_sec=%CHAIN_ELAPSED_SEC%
echo chain_log=%CHAIN_LOG%
echo ==================================================
echo ================================================== >> "%CHAIN_LOG%"
echo BestBuy REF+TV+LDY daily task completed >> "%CHAIN_LOG%"
...
if "%BESTBUY_REF_TV_LDY_DRY_RUN%"=="1" (
...
echo.
echo ==================================================
echo BestBuy REF+TV+LDY daily task completed with failures
...
echo. >> "%CHAIN_LOG%"
echo ================================================== >> "%CHAIN_LOG%"
echo BestBuy REF+TV+LDY daily task completed with failures >> "%CHAIN_LOG%"
