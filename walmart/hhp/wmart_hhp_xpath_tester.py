...
사용법
================================================================================
python walmart/hhp/wmart_hhp_xpath_tester.py
...
DETAIL_XPATH_LIST = {
    ...
    # 'original_sku_price': '//span[@data-seo-id="strike-through-price"]/text()',
     'savings': "//div[@data-testid='dollar-saving']//*[starts-with(normalize-space(), '$')]/text()",
...
LIST_FIELD_XPATHS = {
   ...
   "pick_up_availability": ".//*[@data-testid='badgeTagComponent'][contains(translate(normalize-space(.), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'pickup')]",
    "fastest_delivery": ".//*[@data-testid='badgeTagComponent'][contains(translate(normalize-space(.), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'shipping')]",
    "delivery_availability": ".//*[@data-testid='badgeTagComponent'][contains(translate(normalize-space(.), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'delivery')]",
